...
const config: MenuEntry[] = [
  ...
  // },
  {
    ...
    items: [
      ...
      {
        label: 'Github',
        href: 'https://github.com/pequifinance',
      },
      {
        label: 'Twitter',
        href: 'https://twitter.com/pequifinance',
      },
      {
        label: 'Instagram',
        href: 'https://instagram.com/pequifinance',
      },
      {
        label: 'Telegram',
        href: 'https://t.me/pequifinance',
      },
    ],
  },
]
